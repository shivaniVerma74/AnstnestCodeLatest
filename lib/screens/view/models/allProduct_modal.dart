...
AllProductModal allProductModalFromJson(String str) =>
    AllProductModal.fromJson(json.decode(str));

String allProductModalToJson(AllProductModal data) =>
