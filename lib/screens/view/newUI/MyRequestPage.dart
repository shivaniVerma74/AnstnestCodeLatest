...
class _MyRequestPageState extends State<MyRequestPage> {
  ...
  getMyPostRequest() async {
    var headers = {'Cookie': 'ci_session=5b1m9j8ulbplkuoiu2i8gf4u9smuh16u'};
    var request =
        http.MultipartRequest('POST', Uri.parse('${baseUrl()}/my_post'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: postModel == null || postModel!.data!.isEmpty
            ? Container(
                child: Center(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                "${postModel!.data![i].note![0].toUpperCase() + postModel!.data![i].note!.substring(1)}",
                                style: TextStyle(
                                    color: appColorBlack,
                                    fontSize: 15,
                                    fontWeight: FontWeight.w500),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                " \u{20B9} ${postModel!.data![i].budget}",
                                style: TextStyle(
                                    color: appColorBlack,
                                    fontSize: 15,
                                    fontWeight: FontWeight.w500),
                          ...
                          postModel!.data![i].acceptedBy != null
                              ? MaterialButton(
                                  onPressed: () {
                                    Navigator.push(
                                        context,
